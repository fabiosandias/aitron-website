  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center gradient-bg overflow-hidden">
      ...
      >
        ...
        >
          Transformamos desafios em oportunidades com soluções de IA personalizadas, 
        ...
        >
          <div className="text-center">
            ...
            <p className="text-muted-foreground">IA treinada para seu negócio</p>
          </div>
          <div className="text-center">
            <Zap className="w-12 h-12 mx-auto mb-4 text-primary" />
            <h3 className="text-xl font-semibold mb-2">Automação de Processos</h3>
            <p className="text-muted-foreground">Eficiência máxima e redução de custos</p>
          </div>
          <div className="text-center">
            <Users className="w-12 h-12 mx-auto mb-4 text-primary" />
            <h3 className="text-xl font-semibold mb-2">Consultoria Especializada</h3>
            <p className="text-muted-foreground">Suporte contínuo e personalizado</p>
          </div>
        </motion.div>
      </motion.div>
    </section>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Nossa missão é impulsionar o futuro dos negócios através de soluções de IA que geram valor real e sustentável.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-3xl font-bold mb-4">Nossa História e Propósito</h3>
            <p className="text-lg text-muted-foreground mb-4">
              A Aitron nasceu da visão de transformar o cenário empresarial através do poder da Inteligência Artificial. Desde nossa fundação, temos nos dedicado a desenvolver soluções inovadoras que resolvem problemas complexos e criam novas oportunidades para nossos clientes.
            </p>
            <p className="text-lg text-muted-foreground">
              Acreditamos que a IA não é apenas uma ferramenta, mas um parceiro estratégico capaz de impulsionar a eficiência, otimizar processos e revolucionar a forma como as empresas operam e interagem com seus clientes.
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: 50 }}
          ...
          >
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Estamos sempre à frente, pesquisando e aplicando as mais recentes tecnologias de IA para oferecer soluções de ponta.</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              <Award className="w-10 h-10 text-primary flex-shrink-0" />
              <div>
                <h4 className="text-xl font-semibold">Excelência e Compromisso</h4>
                <p className="text-muted-foreground">Nosso time de especialistas é dedicado a entregar resultados excepcionais, com foco na qualidade e na satisfação do cliente.</p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Trabalhamos lado a lado com nossos clientes, entendendo suas necessidades para construir soluções que gerem valor real e duradouro.</p>
              </div>
            </div>
          </motion.div>
        </div>
  ...
  const benefits = [
    {
      ...
      description: "Sistemas que aprendem e se adaptam às necessidades do seu negócio, otimizando processos e garantindo máxima eficiência."
    },
    {
      icon: HeadphonesIcon,
      title: "Atendimento Aprimorado",
      description: "Suporte instantâneo e personalizado 24/7, elevando a satisfação do cliente e convertendo mais oportunidades de negócio."
    },
    {
      icon: Shield,
      title: "Segurança e Confiabilidade",
      description: "Proteção de dados com criptografia avançada e conformidade com regulamentações, garantindo a integridade e a privacidade das suas informações."
    },
    {
      icon: Target,
      title: "Precisão e Assertividade",
      description: "IA treinada especificamente para o seu contexto, fornecendo respostas e insights precisos para decisões estratégicas e resultados assertivos."
    },
    {
      icon: Rocket,
      title: "Implementação Ágil",
      description: "Deploy rápido e sem interrupções, integrando-se perfeitamente aos seus processos existentes para resultados visíveis em dias."
    },
    {
      icon: CheckCircle,
      title: "Experiência Premium",
      description: "Atendimento personalizado e suporte contínuo que superam expectativas, construindo relacionamentos duradouros e de sucesso."
    }
  ];
    ...
    <section id="beneficios" className="py-20">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Veja como nossas soluções transformam desafios em vantagens competitivas, 
  ...
  const solutions = [
    {
      ...
      description: "IA treinada especificamente para o seu negócio, oferecendo suporte instantâneo e personalizado em qualquer canal, a qualquer hora.",
      features: [
    ...
    },
    {
      ...
      description: "Otimize fluxos de trabalho, elimine tarefas repetitivas e integre sistemas com soluções de IA que aprendem e se adaptam.",
      features: [
    ...
    },
    {
      ...
      description: "Conte com o suporte de nossos especialistas para diagnosticar necessidades, implementar soluções e garantir a evolução contínua da sua estratégia de IA.",
      features: [
    ...
    <section id="solucoes" className="py-20 gradient-bg">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Explore nosso portfólio completo de soluções de IA, projetadas para otimizar cada aspecto do seu negócio.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-muted-foreground text-sm mb-4">
              Transformamos negócios através da inteligência artificial. Criamos soluções personalizadas para automatizar processos, otimizar atendimento e acelerar resultados.
            </p>
          ...
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-4">Soluções Principais</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-4">Segmentos Atendidos</h3>
            <ul className="space-y-2 text-muted-foreground text-sm">
              <li>Corretoras</li>
...
const PartnersSection = () => {
  const partners = [
    ...
    { name: "Evolution Barber", logo: "/assets/partners/evolutionn-barber.png" },
    { name: "Pousada do Golfinho", logo: "/assets/partners/pousada-golfinho.png" },
  ];
    ...
    <section id="parceiros" className="py-20">
      <div className="container mx-auto px-4 text-center">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          De startups a grandes corporações, nossos clientes alcançam resultados excepcionais
        </motion.p>
          ...
          >
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-2xl font-semibold mb-2">Múltiplos Agentes IA</h3>
                  <p className="text-muted-foreground">
                    Tenha um time de agentes especializados em cada etapa do seu negócio, interagindo entre si para alcançar resultados extraordinários. Cada agente pode ter seu próprio modelo, aprendendo continuamente e operando os seus softwares.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Suporte inteligente imediato.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <Brain className="w-8 h-8 text-primary flex-shrink-0 mt-1" />
                <div>
                  <h3 className="text-2xl font-semibold mb-2">Sua IA localmente</h3>
                  <p className="text-muted-foreground">Rodando IA com total controle.</p>
                </div>
              </div>
            </div>
          </motion.div>
    ...
    <section id="revolucao" className="py-20">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto mb-12">
          ...
          >
            <CheckCircle className="w-6 h-6 text-primary flex-shrink-0" />
            <p className="text-foreground text-left">Análise gratuita das suas necessidades</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <p className="text-foreground text-lg">
            Vamos entender sua necessidade e criar uma <span className="text-primary font-semibold">solução de IA personalizada</span> para sua empresa.
          </p>
        </motion.div>
      </div>
    </section>
